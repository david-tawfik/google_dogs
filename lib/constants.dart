...
const double kCommunityTypeDescriptionHeightRatio = 0.018;
const double kCreateCommunityButtonTextHeightRatio = 0.033;
const double kCreateCommunityButtonHeightRatio = 0.075;
const double kErrorTextHeightRatio = 0.018;
const double kCommunityTypeShowModalMaxHeightRatio = 0.35;
